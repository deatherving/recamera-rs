...
// ---------------------------------------------------------------
// ISP types (hand-written — not generated by bindgen)
// ---------------------------------------------------------------

/// Bayer pattern format for ISP.
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum ISP_BAYER_FORMAT_E {
    BAYER_FORMAT_BG = 0,
    BAYER_FORMAT_GB = 1,
    BAYER_FORMAT_GR = 2,
    BAYER_FORMAT_RG = 3,
...
/// ISP public attributes — configures the ISP processing window and sensor mode.
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ISP_PUB_ATTR_S {
...
/// I2C/SSP communication bus info for sensor.
#[repr(C)]
#[derive(Copy, Clone)]
pub union ISP_SNS_COMMBUS_U {
    pub s8I2cDev: CVI_S8,
    pub s8SspDev: CVI_S8,
}

impl std::fmt::Debug for ISP_SNS_COMMBUS_U {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("ISP_SNS_COMMBUS_U")
            .field("s8I2cDev", unsafe { &self.s8I2cDev })
            .finish()
    }
}

/// Sensor configuration passed to CVI_ISP_SnsInit.
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ISP_SNS_CFG_S {
    pub stSnsSize: SIZE_S,
    pub f32FrameRate: CVI_FLOAT,
    pub enWDRMode: WDR_MODE_E,
    pub bHwSync: CVI_BOOL,
    pub S32MipiDevno: CVI_S32,
    pub u8Mclk: CVI_U8,
    pub bMclkEn: CVI_BOOL,
    pub lane_id: [CVI_S16; 5],
    pub pn_swap: [CVI_CHAR; 5],
    pub busInfo: ISP_SNS_COMMBUS_U,
    pub I2cAddr: CVI_S32,
}
